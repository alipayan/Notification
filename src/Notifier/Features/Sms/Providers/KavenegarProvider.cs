...
public class KavenegarProvider
    (IOptions<SmsOptions> options,
    ILogger<KavenegarProvider> logger)
    : ISmsProvider
{
    public string Name => nameof(KavenegarProvider);

    private readonly KavenegarOptions _options = options.Value.Kavenegar;
    private readonly ILogger<KavenegarProvider> _logger = logger;
